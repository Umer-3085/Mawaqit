...
from mawaqit.schemas.category import CategoryCreate, CategoryUpdate, CategoryResponse, CategoryList
...
async def list_categories(
    page: int = 1, page_size: int = 20, service: CategoryService = Depends(get_category_service)
):
