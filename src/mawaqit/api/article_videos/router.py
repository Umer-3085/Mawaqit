...
async def get_article_video(
    id: int, service: ArticleVideoService = Depends(get_article_video_service)
):
...
async def create_article_video(
    ...
    return await service.create(
        data.title, data.category_id, data.detail, data.subcategory_id, data.link
    )
...
async def update_article_video(
    ...
    return await service.update(
        id, data.title, data.detail, data.category_id, data.subcategory_id, data.link
    )
